...
export const TEST_ACCOUNT_KIND = process.env.ROLI_TEST_ACCOUNT_TYPE;
export const TEST_USER = process.env.ROLI_TEST_USER;
export const TEST_PASSWORD = process.env.ROLI_TEST_PASSWORD;